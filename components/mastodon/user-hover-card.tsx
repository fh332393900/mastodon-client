...
export function UserHoverCard({
  ...
  const trigger = children ? (
    ...
    <Link href={profileHref} className="font-semibold text-foreground flex flex-1 flex-wrap md:flex-nowrap items-center min-w-0 w-full px-1 md:px-3 py-1 -ml-3 rounded-full hover:bg-primary-foreground dark:hover:bg-muted overflow-hidden">
